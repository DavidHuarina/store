...
var tablaProductoVentas = $('.tablaVentas').DataTable( {
...
$( '#input_codigo_barras_ventas').on( 'keyup change', function () {
	var valorInput=$(this).val();
	
    cambiarDatosProductosTableVentas(valorInput);
});
function cambiarDatosProductosTableVentas(valorInput){
	tablaProductoVentas.destroy();
    tablaProductoVentas = $('.tablaVentas').DataTable( {
    "ajax": "ajax/datatable-ventas.ajax.php?bar_code="+valorInput,
    "deferRender": true,
	"retrieve": true,
	"processing": true,
	 "language": {
    ...
    initComplete: function () {
           var boton = $("#tablaVentas tbody tr button.agregarProducto");
           if(boton.length==1){
           	 if(!boton.hasClass("btn-default")){
           	 	agregarAlCarrito(boton);
           	 	$( '#input_codigo_barras_ventas').focus(); 
           	 }    
            }  
...
function agregarAlCarrito(boton){
	...
	boton.removeClass("btn-primary agregarProducto");
     ...
     $.ajax({
     	...
     	url:"ajax/productos.ajax.php",
      	...
      	success:function(respuesta){
          	...
          	=============================================*/
            if($("button[idProducto='"+idProducto+"']").length>1){
			    return;
          	}
