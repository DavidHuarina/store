...
class TablaProductos{
	...
	public function mostrarTablaProductos(){
        ...
        if(isset($_GET["bar_code"]) && $_GET["bar_code"] !=""){
          $item="codigo";
          $valor=$_GET["bar_code"];
          $productos = ControladorProductos::ctrMostrarProductosFiltrados($item, $valor, $orden);	
        }else{
		  ...
		  for($i = 0; $i < count($productos); $i++){
		  	...
		  	$imagen = "<img src='".$productos[$i]["imagen"]."' width='100px'>";
